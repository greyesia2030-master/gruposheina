...
export const R = {
  ...
  /** ACK inmediato al recibir Excel */
  processing: () =>
  ...
  /** Pedido creado — se pasa el resumen formateado directamente */
  orderCreated: (summary: string) => summary,

  /** Pedido confirmado exitosamente */
  confirmSuccess: (units: number, week: string) =>
    `✅ ¡Pedido confirmado!\nTotal: *${units} viandas* — ${week}\n\nSi necesitás hacer cambios antes del corte, enviá un nuevo Excel con *reemplazar*.`,
  ...
  /** Se reemplazó el borrador anterior con uno nuevo */
  replacedByNew: () =>
    `🔄 Tu pedido anterior fue cancelado. Te mando el resumen del nuevo...`,
  ...
  /** Advertencia de horario de corte (opcional, al confirmar) */
