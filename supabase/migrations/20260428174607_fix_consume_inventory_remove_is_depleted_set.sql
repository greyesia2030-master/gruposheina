...
-- Filename: 20260428174607_fix_consume_inventory_remove_is_depleted_set
-- Source of truth: live BD (project zenlpuiaavdgeyplfcma)

-- Fix: is_depleted es generated column. No se puede SET manualmente.
...
BEGIN
  ...
  LOOP
    ...
    -- FIX: NO setear is_depleted manualmente (es generated column)
